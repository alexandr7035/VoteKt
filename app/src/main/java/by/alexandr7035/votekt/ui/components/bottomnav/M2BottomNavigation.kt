...
package by.alexandr7035.votekt.ui.components.bottomnav
...
fun M2BottomNavigation(
    ...
    M2BottomNavigation(ZeroInsets, modifier, backgroundColor, contentColor, elevation, content)
}
 ...
 */
@Composable
fun RowScope.M2BottomNavigationItem(
    selected: Boolean,
    onClick: () -> Unit,
